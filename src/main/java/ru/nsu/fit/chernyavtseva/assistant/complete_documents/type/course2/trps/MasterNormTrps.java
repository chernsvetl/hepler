...
import ru.nsu.fit.chernyavtseva.assistant.complete_documents.type.core.NormTprs;
...
public record MasterNormTrps() implements NormTprs {
    ...
    public String fileName() {
        return "Магистратура_Лист_нормоконтроля_ТРПС.docx";
    }
}