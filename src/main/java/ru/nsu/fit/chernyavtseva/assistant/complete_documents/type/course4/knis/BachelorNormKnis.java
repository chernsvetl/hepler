...
import ru.nsu.fit.chernyavtseva.assistant.complete_documents.type.core.NormKnis;
...
public record BachelorNormKnis() implements NormKnis {
    ...
    public String fileName() {
        return "Бакалавриат_Лист_нормоконтроля_КНИС.docx";
    }
}