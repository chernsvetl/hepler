...
import ru.nsu.fit.chernyavtseva.assistant.complete_documents.type.core.ApplicationPractice;
...
public record BachelorApplicationForPracticeKnis() implements ApplicationPractice {
    ...
    public String fileName() {
        return "Прил 4_Заявление на практику_Бакалавриат_КНиС_8 семестр.docx";
    }
}
