...
public record StudentsQuery(String degree, String profile) {
    ...
    public static final String QUERY_TEMPLATE = """
            ...
            ?руководитель_от_организации my:БакДатаРук ?бак_дата_рук .
            ?руководитель_от_организации my:МагДатаМДА ?маг_дата_рук_мда .
            ?руководитель_от_организации my:МагДатаТРПС ?маг_дата_рук_трпс .
