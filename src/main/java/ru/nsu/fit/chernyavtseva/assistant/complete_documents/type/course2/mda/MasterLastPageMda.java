...
import ru.nsu.fit.chernyavtseva.assistant.complete_documents.type.core.LastPageMda;
import java.util.HashMap;
import java.util.Map;
import static ru.nsu.fit.chernyavtseva.assistant.complete_documents.type.ReplacementCreator.simple;


public record MasterLastPageMda() implements LastPageMda {
    ...
    public String fileName() {
        return "Последняя_страница_магистратура_МАД.docx";
    }
}
