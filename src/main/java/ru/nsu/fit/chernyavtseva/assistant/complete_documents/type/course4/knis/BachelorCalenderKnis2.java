...
import ru.nsu.fit.chernyavtseva.assistant.complete_documents.type.core.CalenderKnis2;

import java.util.HashMap;
import java.util.Map;

public record BachelorCalenderKnis2() implements CalenderKnis2 {
    ...
    public String fileName() {
        return "КНИС_Бакалавриат_Календарный_график_выполнения_ВКР_(с_соруководителем).docx";
    }
}