...
import ru.nsu.fit.chernyavtseva.assistant.complete_documents.type.core.PracticeReport;
...
public record BachelorPracticeReportKnis() implements PracticeReport {
    ...
    public String fileName() {
        return "Прил 2_Отчет о практике_Бакалавриат_КНиС_8 семестр.docx";
    }
}
