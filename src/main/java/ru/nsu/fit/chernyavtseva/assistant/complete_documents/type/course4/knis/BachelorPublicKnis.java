...
import ru.nsu.fit.chernyavtseva.assistant.complete_documents.type.core.PublicKnis;
import ru.nsu.fit.chernyavtseva.assistant.complete_documents.type.core.PublicPikn;
...
public record BachelorPublicKnis() implements PublicKnis {
    ...
    public String fileName() {
        return "КНИС_Список_публикаций.docx";
    }
}