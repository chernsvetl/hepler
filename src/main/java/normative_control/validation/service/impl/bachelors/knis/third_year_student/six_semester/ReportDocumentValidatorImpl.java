...
import static normative_control.utils.Files.KNIS_6_REPORT_FILE;
        ...
        for (File file : dir.listFiles((d, name) -> name.toLowerCase().endsWith(".docx"))) {
            try (FileInputStream fis = new FileInputStream(file);
                ...
                if (valid) {
                    ...
                    writeValidationLogs(file.getName() + DOCUMENT_SUCCESS, KNIS_6_REPORT_FILE);
                } else {
            ...
            writeValidationLogs(SPACE, KNIS_6_REPORT_FILE);
        }
        System.out.println(ANSI_BLACK + VALIDATION_END + ANSI_BLACK);
        writeValidationLogs(VALIDATION_END, KNIS_6_REPORT_FILE);
        writeValidationLogs(NEXT_LINE, KNIS_6_REPORT_FILE);
    }
    @Override
