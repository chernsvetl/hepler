package normative_control.validation.service.impl.masters.iiids.second_year_student.fouth_semester;
                ...
                for (XWPFTable table : document.getTables()) {
                    for (int rowIndex = 1; rowIndex < table.getRows().size(); rowIndex++) {
                        ...
                        if (row.getTableCells().size() > dateColumnIndex) {
                            ...
                            var dateOrgStart1 = "05.02.2025";
                            var dateStart1IndividualPlan = "06.02.2025";
                            var dateStart2IndividualPlan = "13.05.2025";
                            var dateOrgStart2 = "07.02.2025";
                            var dateDefendStart1 = "04.05.2025";
                            var dateDefendStart2 = "14.05.2025";
...
//                }
        ...
        try (FileWriter writer = new FileWriter(IIIDS_4_INDIVIDUAL_TASK_FILE + ".json")) {
        ...
        writeValidationLogs(NEXT_LINE, IIIDS_4_INDIVIDUAL_TASK_FILE);
    }
    ...
    public ValidatorDataIndividualTask extractFromSparql(String sparqlQuery) {
        try {
            ...
            while(results.hasNext()){
                ...
                orgStepEndDate = solution.getLiteral("Срок_завершения_организационного_этапа_из_иииds_4").toString();
                prepareAndDefendStepEndDate = solution.getLiteral("Срок_завершения_этапа_подготовки_и_защиты_отчетных_материалов_из_иииds_4").toString();
                prepareAndDefendStepContent = solution.getLiteral("Содержание_работы_подготовки_и_защиты_отчетных_материалов_из_иииds_4").toString();
                orgStepContent = solution.getLiteral("Содержание_работы_организационного_этапа_из_иииds_4").toString();
                individualStepContent = solution.getLiteral("Содержание_работы_выполнения_этапов_индивидуального_задания_из_иииds_4").toString();
                individualStepDate = solution.getLiteral("Срок_завершения_индивидуального_этапа_из_иииds_4").toString();
                individualStepForm = solution.getLiteral("Форма_отчетности_индивидуального_этапа_из_иииds_4").toString();
            }
            qexec.close();
