...
import static normative_control.utils.ValidationPaths.TRPS_2_INDIVIDUAL_TASK_PATH;
...
public class IndividualTaskMainTrps2 {
    public static void main(String[] args) {
        ...
        ValidatorDataIndividualTask data = individualTaskDocumentValidator.extractFromSparql(QUERY_REPORT_TRPS_2);
        if (data != null) {
