...
import static normative_control.utils.ValidationPaths.IIIDS_2_INDIVIDUAL_TASK_PATH;
...
public class IndividualTaskMainIiids2 {
    public static void main(String[] args) {
        ...
        ValidatorDataIndividualTask data = individualTaskDocumentValidator.extractFromSparql(QUERY_REPORT_IIDS_2);
        if (data != null) {
