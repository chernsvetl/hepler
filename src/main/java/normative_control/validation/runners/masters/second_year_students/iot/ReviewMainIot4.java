...
import normative_control.validation.service.impl.masters.iot.second_year_student.fouth_semester.ReviewDocumentValidatorImpl;
...
import static normative_control.utils.ValidationPaths.IOT_4_REVIEW_PATH;

public class ReviewMainIot4 {
    public static void main(String[] args) {
        ReviewDocumentValidator reportDocumentValidator = new ReviewDocumentValidatorImpl();
        ValidatorDataReview data = reportDocumentValidator.extractFromSparql(QUERY_REPORT_IOT_4);
        if (data != null) {
            reportDocumentValidator.validateDocxFiles(IOT_4_REVIEW_PATH, data);
        } else {
