...
import normative_control.validation.service.impl.bachelors.piikn.fourth_year_students.eight_semester.ReportDocumentValidatorImpl;
...
import static normative_control.utils.ValidationPaths.PIIKN_8_REPORT_PATH;

public class ReportMainPiikn8 {
    public static void main(String[] args) {
        ReportDocumentValidator reportDocumentValidator = new ReportDocumentValidatorImpl();
        ValidatorDataReport data = reportDocumentValidator.extractFromSparql(QUERY_REPORT_PIIKN_8);
        if (data != null) {
            reportDocumentValidator.validateDocxFiles(PIIKN_8_REPORT_PATH, data);
        } else {
