...
import normative_control.validation.service.impl.bachelors.knis.fourth_year_students.eight_semester.ReportDocumentValidatorImpl;
...
import static normative_control.utils.ValidationPaths.KNIS_8_REPORT_PATH;

public class ReportMainKnis8 {
    public static void main(String[] args) {
        ReportDocumentValidator reportDocumentValidator = new ReportDocumentValidatorImpl();
        ValidatorDataReport data = reportDocumentValidator.extractFromSparql(QUERY_REPORT_KNIS_8);
        if (data != null) {
