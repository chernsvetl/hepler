...
import static normative_control.utils.ValidationPaths.PIIKN_8_INDIVIDUAL_TASK_PATH;

public class IndividualTaskMainPiikn8 {
    public static void main(String[] args) {
        IndividualTaskDocumentValidator individualTaskDocumentValidator = new IndividualTaskDocumentValidatorImpl();
        ValidatorDataIndividualTask data = individualTaskDocumentValidator.extractFromSparql(QUERY_REPORT_PIIKN_8);
        if (data != null) {
            individualTaskDocumentValidator.validateDocxFiles(PIIKN_8_INDIVIDUAL_TASK_PATH, data);
        } else {
