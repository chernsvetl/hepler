package normative_control.notifications;

public class Notifications {
    public static final String SPARQL_ERROR = "Ошибка выполнения SPARQL запроса: ";
    public static final String PATH_ERROR = "Указанный путь не является директорией.";
