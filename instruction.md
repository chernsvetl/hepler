...
3) Валидация отчета и индивидуального задания осуществляется путем запуска класса, путь которого __*src/main/java/normative_control/validation/Main.java*__
4) Логи об успехе/неудаче нормоконтроля документов можно увидеть в консоли.
