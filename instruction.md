...
7Логи об успехе/неудаче нормоконтроля документов можно увидеть в json файле (он нужен для интеграции с модулем по рассылке доков) (**_файлы будут расположены в корне проекта_**).
